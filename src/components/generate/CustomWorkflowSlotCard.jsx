 ...
 * a one-line summary. Import JSON and the Monstruo Studio bridge live under Advanced;
...
export default function CustomWorkflowSlotCard({
  ...
  const bridgeMessage = String(
    ...
    || bridgeStatus?.error
    || 'Optional bridge lets ComfyUI send the current graph back to Monstruo Studio.'
  ).trim()
            ...
            {bridgeInstalled ? (
              <div className="flex flex-wrap items-center justify-between gap-2">
                <span className="text-[10px] text-emerald-300">
                  Monstruo Studio Bridge installed — Send to Monstruo Studio is available inside ComfyUI.
                </span>
