...
const WORKFLOW_EVIDENCE_OVERRIDES = Object.freeze({
  ...
  'elevenlabs-tts': Object.freeze({
    ...
    evidenceLabel: 'ElevenLabs has historical voice artifacts and a bundled Velorn TTS workflow.',
    qualityObservation: 'Natural voice output is product-proven elsewhere in the ecosystem.',
    limitation: 'The current sandbox credential returned HTTP 401 and this exact bundled workflow still lacks a current receipt.',
  }),
