...
export const useProjectStore = create(
  persist(
    (set, get) => ({
      ...
      // When false (default), Monstruo Studio lands on the project picker so
      ...
      initialize: async () => {
        ...
        try {
          ...
          // By default Monstruo Studio lands on the project picker instead.
      ...
      /**
       * Toggle whether Monstruo Studio should reopen the last project on
